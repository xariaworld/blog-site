...
export const SITE_INTRO = [
  `Welcome to "The Byte 404" - your cozy corner in the digital world! We're all about making tech less of a maze and more of a friendly chat. Here, we break down the geek speak, explore cool gadgets, and share what's buzzing in the tech neighborhood. Join us on this laid-back journey where we unravel the digital mysteries, sprinkle in some fun, and keep things light and breezy.`,
  `Whether you're a tech guru or just dipping your toes into the digital pool, "The Byte 404" is your go-to spot for byte-sized tech stories. So, kick back, relax, and let's navigate the tech world together - no coding manual required! Welcome home.`,
];
